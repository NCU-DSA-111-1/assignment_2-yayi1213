...
//加入鏈結2
void insert2(int data1, int data2, int data3, int data4, char *data5);
//重播
void replay();
//印出過去棋盤
...
void replay()
{
    ...
    do
    {
        ...
        c = link2->xto2;
        d = link2->yto2;
        chessPosition[c][d] = link2->destination2;
    ...
    if (chessPosition[xi][yi] == Red(飛))
    {
            ...
            if (xj >= 7)
        {
            ...
            if (y_n == 'y')
            {
                ...
                insert2(xi, yi, xj, yj, chessPosition[xj][yj]);
